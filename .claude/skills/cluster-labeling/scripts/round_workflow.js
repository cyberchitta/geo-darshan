...
// Each reader gets ITS cards, generated by `gen_round_cards.py --batches`.
// A reader has no shell: it cannot narrow the full file down itself, and giving
// it everyone's cells loads its context with the whole round instead of its
// batch. Set cardsPerBatch:false only for a run whose cards were not split.
const CARDS_PER_BATCH = A.cardsPerBatch !== false
...
a batch that visibly did not run.
